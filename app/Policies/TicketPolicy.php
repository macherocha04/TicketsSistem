...
class TicketPolicy
{
     ...
     */
    public function view(User $user, \App\Models\Ticket $ticket): bool
{
     ...
     */
    public function update(User $user, \App\Models\Ticket $ticket): bool
{
     ...
     */
    public function delete(User $user, \App\Models\Ticket $ticket): bool
{
