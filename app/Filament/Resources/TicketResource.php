...
class TicketResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        ...
        ->columns([
            ...
            TextInputColumn::make('comment') ->disabled(!auth()->user()->hasPermission('ticket_edit')),
    ...
    {
        return [
            TicketResource\RelationManagers\CategoriesRelationManager::class,
            TicketResource\RelationManagers\LabelsRelationManager::class,
